...
<main class="form-signin w-100 m-auto">
    <form action="/login" method="post">
        ...
        <div class="form-floating mt-3">
            <input type="email" class="form-control" name="email" id="floatingInput" placeholder="name@kinopoisk.su">
        ...
        <p class="mt-5 mb-3 text-body-secondary">&copy; Кинопоиск Lite 2024</p>
    </form>
</main>
