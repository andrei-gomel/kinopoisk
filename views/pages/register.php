    ...
    <div class="container d-flex justify-content-center">
        <form action="/register" method="post" class="d-flex flex-column justify-content-center w-50 gap-2 mt-5 mb-5">
            ...
            <div class="row g-2">
                <div class="col-md">
                    <div class="form-floating">
                        <input type="email" class="form-control <?= $session->has('email') ? 'is-invalid' : '' ?>" name="email" id="email" placeholder="name@areaweb.su">
            ...
            <div class="row g-2">
                <div class="col-md">
                    <div class="form-floating">
                        <input type="password" class="form-control <?= $session->has('password') ? 'is-invalid' : '' ?>" id="password" name="password" placeholder="*********">
